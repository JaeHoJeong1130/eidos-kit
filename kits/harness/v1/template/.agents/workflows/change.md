...
1. Read bootstrap and selected route/rubric once; reread when contract, route, or scope changes.
...
3. Search only failure entries matching the route tags.
   Independently select applicable requirements by purpose and planned paths using
